...
public class CreateBook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      if(book_name.isEmpty()){
          msg="Please type the book name corectly .";
      }
      else {
            if(db.createReads(id,date,start,end,book_name)!=0)msg = "Reads table's row successfully added.";
            else msg = "Reads table row not added .";
      }
